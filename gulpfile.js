...
gulp.task('vulcanize', function () {
  return gulp.src('dist/index.html')
    ...
    .pipe(replace('<novulcscript src="/socket.io/socket.io.js"></novulcscript>', '<script src="/socket.io/socket.io.js"></script>'))
    .pipe(gulp.dest('dist/'));
});
...
gulp.task('watchDist', function(){
    ...
    gulp.watch(['app/styles/**/*.css'], build);
    gulp.watch(['app/elements/**/*.css'], build);
    gulp.watch(['app/{scripts,elements}/**/{*.js,*.html}'], build);
    gulp.watch(['app/images/**/*'], build);
});

gulp.task('watch', function(){
    gulp.watch(['app/**/*'],  function (events, done) {
        gulp.start('dev');
    });
});
